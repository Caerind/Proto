...
public:
	...
	static constexpr U32 ConstexprHash(const char* str) { return *str ? static_cast<U32>(*str) + 33 * ConstexprHash(str + 1) : 5381; }
	static constexpr U32 ConstexprHash(std::string_view str) { return str.size() > 0 ? static_cast<U32>(str[0]) + 33 * ConstexprHash(str.substr(1)) : 5381; }
