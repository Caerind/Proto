...
{
	return HasParameter(Hash::Meow32(name.c_str()));
}
...
{
	SetParameterBoolean(Hash::Meow32(name.c_str()), value);
}
...
{
	SetParameterFloat(Hash::Meow32(name.c_str()), value);
}
...
{
	SetParameterInteger(Hash::Meow32(name.c_str()), value);
}
...
{
	SetParameterTrigger(Hash::Meow32(name.c_str()));
}
...
{
	ResetParameterTrigger(Hash::Meow32(name.c_str()));
}
...
{
	return GetParameterBoolean(Hash::Meow32(name.c_str()));
}
...
{
	return GetParameterFloat(Hash::Meow32(name.c_str()));
}
...
{
	return GetParameterInteger(Hash::Meow32(name.c_str()));
}
...
{
	return GetParameterTrigger(Hash::Meow32(name.c_str()));
}
...
{
	return GetParameterIndexByName(Hash::Meow32(name.c_str()));
}
