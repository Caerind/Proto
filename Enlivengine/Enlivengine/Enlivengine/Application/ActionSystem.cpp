...
{
    return IsInputExisting(Hash::Meow32(inputName.c_str()));
}
...
{
    return GetInputByID(Hash::Meow32(inputName.c_str()));
}
...
{
	return GetInputIndexFromID(Hash::Meow32(inputName.c_str()));
}
